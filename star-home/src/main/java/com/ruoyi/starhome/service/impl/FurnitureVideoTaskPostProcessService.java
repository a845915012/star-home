...
//        retryReq.setImageUrls(resolveRetryImageUrls(generationTask, currentTask));
    ...
    private String resolveNextPrompt(FurnitureVideoGenerationTaskDO generationTask) {
        ...
        return "【最高优先级・不可逾越铁则】（视频必须 100% 严格遵守，生成权重拉满）\n" +
                "1.家具主体形态全程恒定铁则："+product+"从视频第一帧到最后一帧，品类、形态、结构、尺寸、朝向、颜色、材质 100% 与用户上传图片完全一致，全程恒定不变。沙发全程为沙发，床全程为床，柜体全程为柜体，绝对禁止出现跨品类替换、形态变形、结构重构、功能篡改（如沙发靠背放倒变床、柜体变形改结构等），无任何穿模、形变、错位。\n" +
                ...
                "【固定参数锁死规范（无缝衔接核心）】\n" +
                "主体还原规则：严格 1:1 还原用户上传图片中的家具外观，画面绝对核心为 **"+product+"，精准呈现"+material+"的真实物理肌理，深度融入【用户补充提示词】** 核心要求，AI 不得做任何自主创意修改、形态重构。 \n" +
                ...
                "\n" +
                "0-1 秒画面100% 承接所有强制锁死规范，起始帧为背景空间完全清晰、家具主体轻微柔化、家具中心严格锁定画面中心、形态 / 朝向与第一段初始帧完全一致的稳定帧，与第一段结尾帧的锚点、光影、色彩、机位、虚化程度完全匹配；启动逆向景深平滑对焦，焦点从背景空间，以与第一段结尾完全一致的恒定速度，缓慢向画面中心绝对静止的家具主体转移，同时保持与第一段完全同速的正向轨道微推运镜；家具全程形态、结构、品类 100% 恒定不变，无任何变形、替换；全程无变速、无跳切，景深过渡完全掩盖拼接痕迹，画面全程无水印\n" +
                "1-2 秒完成景深对焦，焦点 100% 锁定画面中心绝对静止的家具主体，背景回归柔和虚化；保持同方向、同速度匀速微推，镜头从家具整体近景，平稳过渡到家具核心功能部件的精准特写（如柜体柜门、沙发扶手、床体靠背、五金配件）；家具形态、结构、品类与用户上传图片 100% 完全一致，无任何变更；全程运镜丝滑无卡顿，光影精准打亮功能部件，突出结构设计的精致感，无水印、无多余画面元素\n" +
                "2-3 秒保持同速匀速微推，以真人实拍商业片的克制逻辑，纯静态展示家具核心功能的精工细节（如柜门闭合状态的无痕封边、抽屉导轨的严丝合缝、面料拼接的工整缝线、台面的耐刮质感）；家具全程绝对静止，无任何开合、伸缩、变形等动态，形态、结构全程恒定不变，无穿模、无结构错乱，极致还原产品的真人实拍级质感\n" +
                "3-4 秒镜头切换为与家具正面平行的横向长距离匀速滑轨平移（右→左），平移速度与全程运镜速度完全匹配，无任何变速，镜头始终与家具正面保持垂直；家具全程绝对静止，形态、结构、朝向与初始帧 100% 完全一致，无任何旋转、变形；完整展现家具的侧面轮廓、线条美学与整体结构比例，背景空间与第一段完全统一，无任何视觉割裂，画面无水印、无抖动\n" +
                "4-5 秒保持同方向、同速度匀速平移，镜头焦点精准推进到家具的隐蔽工艺细节特写，极致呈现高端商业片核心种草点：板材拼接的严丝合缝、封边工艺的无痕过渡、五金配件的细腻金属光泽、边角的圆润打磨、实木纹理的自然连贯；家具全程绝对静止，形态、结构、品类无任何变更，光影柔和突出材质与工艺的高级质感，无虚化失焦、无水印\n" +
                "5-6 秒镜头结束横向平移，精准回归与家具中心轴线垂直的正向机位，保持全程恒定速度匀速向后拉远，仅做景别变化，无任何其他操作；从工艺细节特写顺滑过渡到家具完整中景，家具主体的形态、结构、品类、朝向与初始帧、用户上传图片 100% 完全一致，无任何变形、替换、重构，沙发始终为沙发，床始终为床，无任何品类与形态变更；完整呈现家具的整体造型与设计完整性，背景空间随镜头拉远逐步清晰，突出家具在空间中的视觉重心地位，无任何元素抢夺主体焦点\n" +
                "6-7 秒保持同速匀速向后拉远，镜头从家具中景平稳过渡到空间全景，家具全程绝对静止，形态、结构、品类恒定不变；完整呈现家具与整个家居空间的融合效果，展现产品为空间赋予的高级质感与氛围感，画面层次丰富、光影通透自然，家具始终处于画面视觉 C 位，全程无水印、无色彩跳变\n" +
                "7-8 秒镜头最终平稳定格在家具与空间融合的完整全景高级感画面，家具的朝向、形态、结构、品类与视频初始帧、用户上传图片 100% 完全一致，无任何变更；保持光影全程恒定，画面以极缓的线性速度柔和均匀变暗，最终干净落幅，无任何画面抖动、突兀转场与暗场跳变，完美契合高端商业宣传片的收尾标准";
    }
